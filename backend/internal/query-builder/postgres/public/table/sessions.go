...
func newSessionsTableImpl(schemaName, tableName, alias string) sessionsTable {
	var (
		...
		allColumns      = postgres.ColumnList{IDColumn, UserIDColumn, IsActiveColumn, ExpiresAtColumn}
		mutableColumns  = postgres.ColumnList{UserIDColumn, IsActiveColumn, ExpiresAtColumn}
		defaultColumns  = postgres.ColumnList{}
	)
